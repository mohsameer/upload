...
#----------QA Example PRofit ------------
CLIENT_ID = "2623f77f-3e97-4215-978f-98636bde65ea"
CLIENT_SECRET = "YS6QxAsHRNUbjptvlZw0c0Uesx6e52qQBCiLGwWw"
#
...
SCIM_CREATE_URL = "https://qa-idm.pps.co.za/midpoint/ws/services/scim2/Users"
...
CLIENT_ID = "ae318769-653a-4c62-8d24-dddbc971c585"
CLIENT_SECRET = "nwIh0xfPVE7C0WEJOi1LY4VTBZhBq5CawT0M53kv"
USERNAME = "zreon9"
...
SCIM_CREATE_URL = "https://pre-idm.pps.co.za/midpoint/ws/services/scim2/Users"
...
CLIENT_ID = "2e15b236-7d92-46a8-b75a-d66f09344414"
CLIENT_SECRET = "IAUXoKM8nNjsHY96UiGOLqq1KVSebQk8ENIFQx5E"
USERNAME = "zreon9"
PASSWORD = "Password@123"
...
SCIM_CREATE_URL = "https://idm.pps.co.za/midpoint/ws/services/scim2/Users"
...
#TOKEN_AUTH_TYPE="client_secret_post"
...
authorize_call = f"{OIDC_URL}/oidc/restv1/authorize?client_id={CLIENT_ID}&redirect_uri={REDIRECT_URL}&response_type=code&scope=openid%20profile%20email"
if ENABLE_PCKE:
...
otp_codes = fetch_otp()
print("Extracted OTPs:", otp_codes)
if not otp_codes:
    print("Otp not found ....")
    sys.exit(1)
...
response = session.request("POST", SCIM_CREATE_URL, headers=headers, json=payload)
...
saID = "0001315549087" # PPD
saID = "0001010609087" # QA
response = requests.post(IDM_SEARCH_URL, json={"filter": "saID eq \"{id}\"".replace("{id}", saID)},
                                 headers={"Authorization": SCIM_AUTHORIZATION})
if response.json()["totalResults"] == 1:
    ...
    #print(response.json()["Resources"][0]["urn:ietf:params:scim:schemas:extension:custom:2.0:User"]["registered"])
    response = requests.request("DELETE", SCIM_CREATE_URL+"/"+idmUserId, data={},
                                     headers={"Authorization": SCIM_AUTHORIZATION})
