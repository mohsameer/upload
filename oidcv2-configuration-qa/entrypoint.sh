...
exec java \
    ...
    -jar /opt/jetty/start.jar \
        --lib=/opt/jans/jetty/jans-auth/custom/libs/jackson-databind-2.13.4.jar \
        --lib=/opt/jans/jetty/jans-auth/custom/libs/jackson-core-2.13.4.jar \
        --lib=/opt/jans/jetty/jans-auth/custom/libs/jackson-annotations-2.13.4.jar \
